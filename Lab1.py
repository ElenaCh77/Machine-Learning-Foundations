...
# YOUR CODE HERE
new_random_M_column = random_M[:,1]
print(new_random_M_column)
...
sliced_random_M = random_M[2:7, 0:2]
...
print(dataFrame4.columns.tolist())
